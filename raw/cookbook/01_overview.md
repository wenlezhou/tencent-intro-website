...
### Tool Use and Integration
- `tool_use/` - External tool integration examples
- `misc/` - Miscellaneous practical tutorials

### Third-Party Integrations
- `third_party/` - Vector databases, Wikipedia, web pages

### Multimodal Capabilities
- `multimodal/` - Vision and image understanding examples

### Advanced Techniques
- `extended_thinking/` - Extended thinking examples
